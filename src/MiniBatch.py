class MiniBatch:
    def __init__(self, x:list, y:list, batch_num, w, b, alpha=0.01, epochs=10000):
        self.x = x
        self.y = y
    ...
    def update(self):
        ...
        for i in range(self.batch_num):
            ...
            for _ in range(self.epochs):
                self.b,self.w = self.b - self.alpha*(-2/batch_size)*(y_sum - self.b*n - self.w*x_sum),self.w - self.alpha*(-2/batch_size)*(xy_sum - self.b*x_sum - self.w*x2_sum)
